...
public static class TorBridges
{
    ...
    public static readonly IReadOnlyList<string> Obfs4Iat = new[]
    {
    ...
    public static readonly IReadOnlyList<string> Obfs4Public = new[]
    {

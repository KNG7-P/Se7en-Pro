...
public static class CdnFrontingBuilder
{
    ...
    public static readonly IReadOnlyList<(string OverrideId, string IpAddress)> DefaultEdgeIps =
        new (string, string)[]
        {
            ...
            ("edge-ir-4",     "184.24.77.11"),
            ("edge-ir-5",     "184.24.77.7"),
            ("edge-ir-6",     "184.24.77.5"),
            ("edge-ir-7",     "185.200.232.49"),
            ("edge-ir-8",     "185.200.232.50"),
            ("edge-ir-9",     "185.200.232.42"),
            ("edge-ir-10",    "185.200.232.41"),
            ("edge-ir-11",    "23.48.23.151"),
            ("edge-ir-12",    "23.48.23.186"),
            ("edge-ir-13",    "23.48.23.133"),
            ("edge-ir-14",    "23.58.193.140"),
            ("edge-ir-15",    "23.43.237.239"),
            ("edge-ir-16",    "104.112.146.82"),
            ("edge-ir-17",    "104.64.0.5"),
            ("edge-ir-18",    "2.22.250.149"),
            ("edge-ir-19",    "2.19.126.81"),
            ("edge-ir-20",    "92.16.53.11"),
            ("edge-ir-21",    "92.122.0.1"),
            ("edge-ir-22",    "72.246.28.3"),
        };
